  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        productos: JSON.stringify(items), // Convertir items a JSON string
      ...
      if (response.success) {
        ...
        toast({
          ...
          description: response.message || "No se pudo completar tu pedido. Inténtalo de nuevo.",
          variant: "destructive"
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "Ocurrió un error al procesar tu pedido. Inténtalo de nuevo.",
        variant: "destructive"
      });
    } finally {
